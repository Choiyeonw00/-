...
// Servo adjustment
#define _DUTY_MAX 2200  // Servo angle: D degree
#define _DUTY_NEU 1500  // Servo angle: 0 degree
#define _DUTY_MIN 1058   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 80 // Replace with |D - E| degree
#define _SERVO_SPEED 900 // servo speed limit (unit: degree/second)

#define _BANGBANG_RANGE 250
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return (504 -1.71*x + 1.45*0.001*x*x);
}
